...
;; Author: Dr. Rafael Sep�lveda. <drs@gnulinux.org.mx>
;; Mantainer: Dr. Rafael Sep�lveda. <drs@gnulinux.org.mx>

;; Copyright (C) 2001-2003, Dr. Rafael Sep�lveda <drs@gnulinux.org.mx>
...
;;           components. (Dr. Rafael Sep�lveda <drs@gnulinux.org.mx>)
;;       -- Change the web page address form where you can find the latest version.
;;	     (Dr. Rafael Sep�lveda <drs@gnulinux.org.mx>)
